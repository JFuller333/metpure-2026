/* USF file - DO NOT MODIFY THIS FILE. THIS FILE IS REGULARLY CHANGED BY USF APP AND **ANY DIRECT CHANGES WILL BE LOST**. Use our in-app customization if you need to update CSS and JS code. Auto modified at: 12/11/2024 8:40:02 AM*/
...
/* Begin plugin code */
usf.plugins.push({render_searchResultsProductReview:(e,r,d,t)=>r("div",{attrs:{"data-fera-container":554475,"data-product_id":d.product.id}})}),usf.event.add(["sr_updated","sr_viewChanged","rerender"],function(){window.fera&&fera.refreshContent&&fera.refreshContent()}),usf.event.raise("rerender");
